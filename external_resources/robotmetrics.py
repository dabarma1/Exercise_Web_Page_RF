...
logo = "https://cx.sap.com/medias/sys_master/Partners/Partners/h52/ha4/8809385459742/logo-partner2015-thinkwrap.png"
        ...
        <div class="row">
            <nav class="col-md-2 d-none d-md-block bg-light sidebar" style="font-size:16px;">
				...
				<h6 class="sidebar-heading d-flex justify-content-between align-items-center text-muted">
                    ...
                    <ul class="nav flex-column mb-2">
                        <li class="nav-item">
                            <a style="color:blue;" class="tablink nav-link" href="https://bitbucket.org/account/user/thinkwrap/projects/H3">
							  <i class="fa fa-external-link"></i> Bitbucket
							</a>
                        </li>                    
                        <li class="nav-item">
...
To: david.barba@thinkwrap.com; joseantonio.hernandez@thinkwrap.com
